...
router.post("/board/:slug/:displayId/edit", requireAuthRedirect, enforcePostMutationRateLimit, postArticleEdit);
router.post("/board/:slug/:displayId/delete", requireAuthRedirect, enforcePostMutationRateLimit, deleteArticle);
