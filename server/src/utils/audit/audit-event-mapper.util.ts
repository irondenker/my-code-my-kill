 ...
 */
export function buildLoginFailedAuditLogWriteParams(
  params: AuditRequestMetaFields & {
 ...
 */
export function buildLoginSuccessAuditLogWriteParams(
  params: AuditRequestMetaFields & {
    userId: number;
    username: string;
    userRole: UserRole;
 ...
 */
export function buildLogoutSuccessAuditLogWriteParams(
  params: AuditRequestMetaFields & {
    userId: number;
 ...
 */
export function buildAdminPageAccessAttemptAuditLogWriteParams(
  params: AuditActorFields &
    AuditHttpRequestMetaFields & {
 ...
 */
export function buildAuthzDeniedAuditLogWriteParams(
  params: AuditActorFields &
    AuditHttpRequestMetaFields & {
      reason: string;
    }
 ...
 */
export function buildCsrfInvalidAuditLogWriteParams(
  params: AuditActorFields & AuditHttpRequestMetaFields
): AuditLogWriteParams {
  return {
    action: 'CSRF_INVALID',
    actorUserId: params.actorUserId,
 ...
 */
export function buildAccountStatusChangedAuditLogWriteParams(
  params: AuditRequestMetaFields & {
    actorUserId: number;
    actorUsername: string | null;
    targetUserId: number;
 ...
 */
export function buildAdminRoleChangedAuditLogWriteParams(
  params: AuditRequestMetaFields & {
    actorUserId: number;
    actorUsername: string | null;
    targetUserId: number;
...
export function buildAccountLockedAuditLogWriteParams(
  params: AuditRequestMetaFields & {
    targetUserId: number;
    targetUsername: string;
    failedCount: number;
...
export function buildPasswordResetRequestedAuditLogWriteParams(
  params: AuditRequestMetaFields & {
    targetUserId: number | null;
    targetUsername: string | null;
...
export function buildPasswordResetCompletedAuditLogWriteParams(
  params: AuditRequestMetaFields & {
    targetUserId: number;
    targetUsername: string;
    result: 'success';
...
export function buildRateLimitedAuditLogWriteParams(
  params: AuditRequestMetaFields & {
