...
export const ARTICLE_IMAGE_ALLOWED_MIME_TYPES: ReadonlySet<string> = new Set([
  'image/jpeg',
  'image/png',
  'image/webp',
]);
...
export const ARTICLE_ATTACHMENT_EXTENSIONS: ReadonlySet<string> = new Set([
  '.pdf',
  '.txt',
  '.csv',
  '.zip',
...
export const ARTICLE_IMAGE_UPLOAD_DIR = path.join(
  process.cwd(),
  'public',
  'uploads',
  'posts',
...
export const ARTICLE_ATTACHMENT_UPLOAD_DIR = path.join(
  process.cwd(),
  'public',
  'uploads',
  'posts',
