...
export const POST_IMAGE_ALLOWED_MIME_TYPES: ReadonlySet<string> = new Set(["image/jpeg", "image/png", "image/webp"]);

export const POST_ATTACHMENT_ALLOWED_MIME_TYPES: ReadonlySet<string> = new Set([
    "application/pdf",
    "text/plain",
    "text/csv",
...
export const POST_IMAGE_OUTPUT_QUALITY = 82;
export const POST_IMAGE_MAX_OUTPUT_WIDTH = 1280;
